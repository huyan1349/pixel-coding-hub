  ...
  return (
    <div className="w-screen h-screen bg-pixel-bg text-pixel-text flex flex-col overflow-hidden select-none">
      ...
      <div className="flex-1 grid grid-cols-12 overflow-hidden">
        <aside className="col-span-12 md:col-span-3 border-r-0 md:border-r-2 border-pixel-text bg-pixel-dark p-3 overflow-y-auto">
          {sidebar}
        </aside>
        <main className="col-span-12 md:col-span-9 flex flex-col overflow-hidden bg-pixel-bg">
          ...
          <div className="h-48 border-t-2 border-pixel-text bg-pixel-dark">{bottom}</div>
        </main>
      </div>
    </div>
  );
